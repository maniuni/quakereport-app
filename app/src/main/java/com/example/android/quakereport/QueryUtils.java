...
public final class QueryUtils {
    ...
    /**
     * Query the USGS dataset and return an ArrayList<Earthquake> to represent a list of earthquakes.
     */
    public static List<Earthquake> fetchEarthquakeData(String requestUrl) {
        ...
        // an ArrayList<Earthquake> with the list of {@link Earthquake} objects.
    ...
    // Make an HTTP connection to the internet using the given {@link URL} object
    // and return a String as a response.
    ...
    // Convert the {@link InputStream} object into a String
    // which contains the JSON response from the server.
    ...
    private static List<Earthquake> extractEarthquakesFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for(int i = 0; i < features.length(); i++){
                ...
                // Extract the "url" for website details
                String url = properties.getString("url");

                // Create Earthquake java object from magnitude, location, and time
                Earthquake earthquake = new Earthquake(location, mag, time, url);
